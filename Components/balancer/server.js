...
// 
var available = [];// aqui se almacenan los tickets del frontend
// 1 entrada por cada ticket q le envie el frontend al balancer
...
var server = http.createServer(function (request, response) {
    ...
    var reqId   = gbinstance.newRequestId(); //Calcula el timestamp
